...
const EsqueciSenha = (dados:any) =>{
    const iframeUrl = 'https://portal-santa-casa-front.caprover.santacasacopacabana.com.br/esquecisenha';

    function MudouURL(dadosLocalIframe:any)
    {
        //console.log(dadosLocalIframe);
        if(dadosLocalIframe.url != "https://portal-santa-casa-front.caprover.santacasacopacabana.com.br/esquecisenha")
        {
